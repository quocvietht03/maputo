!(function ($) {
	...
	/* Toggle menu mobile */
	function MaputoToggleMenuMobile() {
	...
	function MaputoToggleSubMenuMobile() {
	...
	jQuery(document).ready(function ($) {
		MaputoSubmenuAuto();
		MaputoToggleMenuMobile();
		MaputoToggleSubMenuMobile();
		MaputoOrbitEffect();
		MaputoCursorEffect();
		MaputoBubleEffect();
		MaputoShop();
		MaputoUnitsCustom();
		MaputoCheckboxCustom();
		MaputoBorderTop();
	});
