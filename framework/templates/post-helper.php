<?php
/* Count post view. */
if (!function_exists('maputo_set_count_view')) {
  function maputo_set_count_view()
  {
    $post_id = get_the_ID();

    if (is_single() && !empty($post_id) && !isset($_COOKIE['maputo_post_view_' . $post_id])) {
      ...
      /* set cookie. */
      setcookie('maputo_post_view_' . $post_id, $post_id, time() * 20, '/');
    }
  }
}
add_action('wp', 'maputo_set_count_view');

/* Post count view */
if (!function_exists('maputo_get_count_view')) {
  function maputo_get_count_view()
  {
    $post_id = get_the_ID();
    $views = get_post_meta($post_id, '_post_count_views', true);

    $views = $views ? $views : 0;
    $label = $views > 1 ? esc_html__('Views', 'maputo') : esc_html__('View', 'maputo');
    return $views . ' ' . $label;
  }
}

/* Post Reading */
if (!function_exists('maputo_reading_time_render')) {
  function maputo_reading_time_render()
  {
...
/* Single Post Title */
if (!function_exists('maputo_single_post_title_render')) {
  function maputo_single_post_title_render()
  {
    ob_start();
?>
...
/* Post Title */
if (!function_exists('maputo_post_title_render')) {
  function maputo_post_title_render()
  {
    ob_start();
  ?>
    <h3 class="bt-post--title">
...
/* Post Featured */
if (!function_exists('maputo_post_featured_render')) {
  function maputo_post_featured_render($image_size = 'full')
  {
    ob_start();
...
/* Post Cover Featured */
if (!function_exists('maputo_post_cover_featured_render')) {
  function maputo_post_cover_featured_render($image_size = 'full')
  {
    ob_start();
    ?>
    <div class="bt-post--featured">
...
/* Post Publish */
if (!function_exists('maputo_post_publish_render')) {
  function maputo_post_publish_render()
  {
    ob_start();
...
/* Post Short Meta */
if (!function_exists('maputo_post_short_meta_render')) {
  function maputo_post_short_meta_render()
  {
    ob_start();
  ...
  ?>
    <div class="bt-post--meta">
      ...
      echo maputo_reading_time_render();
      ?>
    </div>
  <?php
...
/* Post Meta */
if (!function_exists('maputo_post_meta_render')) {
  function maputo_post_meta_render()
  {
    ob_start();
      ...
      <ul class="bt-post--meta">
        <li class="bt-meta bt-meta--author">
          <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>">
            ...
            <?php echo esc_html__('By', 'maputo') . ' ' . get_the_author(); ?>
          </a>
        </li>
        <li class="bt-meta bt-meta--view">
          <a href="<?php echo get_the_permalink(); ?>">
            ...
            <?php echo maputo_get_count_view(); ?>
          </a>
        </li>
        ...
        <li class="bt-meta bt-meta--comment">
          <a href="<?php comments_link(); ?>">
            ...
            <?php comments_number(esc_html__('0 Comments', 'maputo'), esc_html__('1 Comment', 'maputo'), esc_html__('% Comments', 'maputo')); ?>
          </a>
        </li>
      </ul>
      <?php
      echo maputo_share_render();
      ?>
    </div>
    <?php
    return ob_get_clean();
...
/* Post Category */
if (!function_exists('maputo_post_category_render')) {
  function maputo_post_category_render()
  {
    $post_id = get_the_ID();
...
/* Post Content */
if (!function_exists('maputo_post_content_render')) {
  function maputo_post_content_render()
  {
    ...
    ?>
      <div class="bt-post--content">
        ...
        the_content();
        wp_link_pages(array(
          'before' => '<div class="page-links">' . esc_html__('Pages:', 'maputo'),
          'after' => '</div>',
        ));
        ?>
      </div>
...
/* Post tag */
if (!function_exists('maputo_tags_render')) {
  function maputo_tags_render()
  {
    ob_start();
    if (has_tag()) {
    ?>
...
/* Post share */
if (!function_exists('maputo_share_render')) {
  function maputo_share_render()
  {

    $social_item = array();
    $social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-linkedin" data-toggle="tooltip" title="' . esc_attr__('Linkedin', 'maputo') . '" href="https://www.linkedin.com/shareArticle?url=' . get_the_permalink() . '">
                          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
    ...
    $social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-facebook" data-toggle="tooltip" title="' . esc_attr__('Facebook', 'maputo') . '" href="https://www.facebook.com/sharer/sharer.php?u=' . get_the_permalink() . '">
    ...
    $social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-google-plus" data-toggle="tooltip" title="' . esc_attr__('Google Plus', 'maputo') . '" href="https://plus.google.com/share?url=' . get_the_permalink() . '">
    ...
    $social_item[] = '<li>
                      <a target="_blank" data-btIcon="fa fa-twitter" data-toggle="tooltip" title="' . esc_attr__('Twitter', 'maputo') . '" href="https://twitter.com/share?url=' . get_the_permalink() . '">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
    ...
    if (is_singular('post') && has_tag()) { ?>
      <div class="bt-post-share">
        <?php if (!empty($social_item)) {
          echo '<span>' . esc_html__('Share: ', 'maputo') . '</span><ul>' . implode(' ', $social_item) . '</ul>';
        } ?>
      </div>
    ...
    <?php } elseif (!empty($social_item)) { ?>
      ...
      <div class="bt-post-share">
        <span><?php echo esc_html__('Share: ', 'maputo'); ?></span>
...
/* Post Button */
if (!function_exists('maputo_post_button_render')) {
  function maputo_post_button_render($text)
  { ?>
...
/* Book Now Button */
if (!function_exists('maputo_service_button_book_now_render')) {
  function maputo_service_button_book_now_render($text)
  {
...
/* Author Icon */
if (!function_exists('maputo_author_icon_render')) {
  function maputo_author_icon_render()
  { ?>
    <div class="bt-post-author-icon">
      ...
      <h4 class="bt-post-author-icon--name"> <?php echo esc_html__('By', 'maputo') . ' ' . get_the_author(); ?> </h4>
    </div>
  <?php }
}

/* Author */
if (!function_exists('maputo_author_render')) {
  function maputo_author_render()
  {
...
/* Related posts */
if (!function_exists('maputo_related_posts')) {
  function maputo_related_posts()
  {
    $post_id = get_the_ID();
    $cat_ids = array();
    ...
    ?>
      <div class="bt-related-posts">
        <div class="bt-related-posts--heading">
          <h4 class="bt-sub"><?php esc_html_e('From The Blog', 'maputo'); ?></h4>
          <h2 class="bt-head"><?php esc_html_e('Related News ', 'maputo'); ?><span><?php esc_html_e('& Articles', 'maputo'); ?></span></h2>
        </div>
...
//Comment Field Order
function maputo_comment_fields_custom_order($fields)
{
...
add_filter('comment_form_fields', 'maputo_comment_fields_custom_order');

/* Custom comment list */
if (!function_exists('maputo_custom_comment')) {
  function maputo_custom_comment($comment, $args, $depth)
  {
      ...
      <div class="bt-comment">
        ...
        <div class="bt-content">
          ...
          <?php if ($comment->comment_approved == '0') : ?>
            <em class="comment-awaiting-moderation"><?php esc_html_e('Your comment is awaiting moderation.', 'maputo'); ?></em>
          <?php endif; ?>
          <div class="bt-text">
            <?php comment_text(); ?>
          </div>
