...
namespace MaputoElementorWidgets\Widgets\HighlightedHeading;
...
class Widget_HighlightedHeading extends Widget_Base
{
	...
	{
		return __('Highlighted Heading', 'maputo');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'before_text',
			[
				'label'       => esc_html__('Before Text', 'maputo'),
		...
		$this->add_control(
			'highlighted_text',
			[
				'label'       => esc_html__('Highlighted Text', 'maputo'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('Highlighted', 'maputo'),
			]
		);
		...
		$this->add_control(
			'after_text',
			[
				'label'       => esc_html__('After Text', 'maputo'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => '',
			]
