<?php
namespace MaputoElementorWidgets\Widgets\ServiceLoopItem;
...
class Widget_ServiceLoopItem extends Widget_Base {
	...
	public function get_title() {
		return __( 'Service Loop Item', 'maputo' );
	}
	...
	protected function register_style_section_controls() {
		...
		$this->add_control(
			'background_content',[
				'label'     => esc_html__( 'Background Content', 'maputo' ),
		...
		$this->add_control(
			'title_color_hover',[
				'label'     => esc_html__( 'Color Hover', 'maputo' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),[
				...
				'label'    => esc_html__( 'Typography', 'maputo' ),
				'default'  => '',
		...
		$this->add_control(
			'description_style',[
				'label' => esc_html__( 'Description', 'maputo' ),
				'type'  => Controls_Manager::HEADING,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'price_background',[
				'label'     => esc_html__( 'Background', 'maputo' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'button_style',[
				'label' => esc_html__( 'Button', 'maputo' ),
				'type'  => Controls_Manager::HEADING,
			]
		);
