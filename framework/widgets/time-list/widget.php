...
namespace MaputoElementorWidgets\Widgets\TimeList;
...
class Widget_TimeList extends Widget_Base
{
	...
	protected function register_layout_section_controls()
	{
		...
		$this->add_control(
			'time_list_enable',
			[
				'label' => __('Enable Custom List', 'maputo'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Yes', 'maputo'),
				'label_off' => __('No', 'maputo'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'list',
			[
				'label' => __('List Time', 'maputo'),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'time_title' => __('Monday', 'maputo'),
						'time_hours' => __('12:00 pm - 08:00 pm', 'maputo'),

					],
					[
						'time_title' => __('Tuesday To Friday', 'maputo'),
						'time_hours' => __('06:00 pm - 05:00 pm', 'maputo'),
					],
					[
						'time_title' => __('Saturday - Sunday', 'maputo'),
						'time_hours' => __('8:00 am - 3:30 pm', 'maputo'),
					],
				],
