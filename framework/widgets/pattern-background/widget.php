<?php
namespace MaputoElementorWidgets\Widgets\PatternBackground;
...
class Widget_PatternBackground extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pattern Background', 'maputo' );
	}
