...
namespace MaputoElementorWidgets\Widgets\LocationList;
...
class Widget_LocationList extends Widget_Base
{
    ...
    {
        return __('Location List', 'maputo');
    }
    ...
    protected function register_layout_section_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => __('Our Locations', 'maputo'),
            ]
        );
        $repeater->add_control(
            'location_address',
            [
                'label' => __('Address', 'maputo'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => '',
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Enquire', 'maputo'),
            ]
        );
        $repeater->add_control(
            'location_button_link',
            [
                'label' => __('Button Link', 'maputo'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => '',
            ]
        ...
        $repeater->add_control(
            ...
            [
                'label' => __('Opening Hours', 'maputo'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Opening Hours', 'maputo'),
            ]
        );
        ...
        $nested_repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Monday To Friday', 'maputo'),
            ]
        );
        ...
        $nested_repeater->add_control(
            'sub_location_hours',
            [
                'label' => __('Hours', 'maputo'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('12:00 pm - 08:00 pm', 'maputo'),
            ]
        );
        $repeater->add_control(
            'location_time',
            [
                'label' => __('Time List', 'maputo'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $nested_repeater->get_controls(),
                'default' => [
                    [
                        'sub_location_title' => __('Monday To Friday', 'maputo'),
                        'sub_location_hours' => __('12:00 pm - 08:00 pm', 'maputo'),
                    ],
                    [
                        'sub_location_title' => __('Saturday - Sunday', 'maputo'),
                        'sub_location_hours' => __('06:00 pm - 05:00 pm', 'maputo'),
                    ],
                ],
        ...
        $this->add_control(
            'list',
            [
                'label' => __('Location list', 'maputo'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'location_title' => __('Sydney Double Bay', 'maputo'),
                        'location_address' => __('66 Broklyn New Golden Street USA', 'maputo'),
                        'location_button' => __('Enquire', 'maputo'),
                        'location_button_link' => '#',
                        'location_opening_hours' => __('Opening Hours', 'maputo'),
                        'location_time' => [
                            [
                                'sub_location_title' => __('Monday To Friday', 'maputo'),
                                'sub_location_hours' => __('12:00 pm - 08:00 pm', 'maputo'),
                        ...
                        'location_email' => __('help@company.com', 'maputo'),
                        'location_phone' => __('+1(800)123-4566', 'maputo'),
                        'location_maps_zoom' => '12',
                    ],
                    [
                        'location_title' => __('Newport Beach', 'maputo'),
                        'location_address' => __('854 Avocado Ave. Street USA', 'maputo'),
                        'location_button' => __('Enquire', 'maputo'),
                        'location_button_link' => '#',
                        'location_opening_hours' => __('Opening Hours', 'maputo'),
                        'location_time' => [
                    ...
                    [
                        'location_title' => __('Waikoloa, USA', 'maputo'),
                        'location_address' => __('Waikoloa Beach Resort, Unit D-8 250 Waikoloa Beach', 'maputo'),
                        'location_button' => __('Enquire', 'maputo'),
                        'location_button_link' => '#',
                        'location_opening_hours' => __('Opening Hours', 'maputo'),
                        'location_time' => [
    ...
    protected function register_style_section_controls()
    {
        $this->start_controls_section(
            'section_style_item',
            [
                'label' => esc_html__('General', 'maputo'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Opening Hours', 'maputo'),
                'type' => Controls_Manager::HEADING,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('List Time', 'maputo'),
                'type' => Controls_Manager::HEADING,
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Hours Typography', 'maputo'),
                'default' => '',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Content Typography', 'maputo'),
                'default' => '',
                                    ...
                                    <div class="bt-location-list--meta-item">
                                        <a href="<?php echo esc_url('mailto:' . $item['location_email']); ?>">
                                            ...
                                            <div class="bt-location-info">
                                                <h4><?php echo esc_html__('Email:', 'maputo'); ?></h4>
                                ...
                                <?php if (!empty($item['location_phone'])) : ?>
                                    <div class="bt-location-list--meta-item">
                                        <a href="<?php echo esc_url('tel:' . preg_replace('/[^0-9]+/', '', $item['location_phone'])); ?>">
                                            ...
                                            <div class="bt-location-info">
                                                <h4><?php echo esc_html__('Phone:', 'maputo'); ?></h4>
