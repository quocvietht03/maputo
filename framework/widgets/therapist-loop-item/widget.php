<?php
namespace MaputoElementorWidgets\Widgets\TherapistLoopItem;
...
class Widget_TherapistLoopItem extends Widget_Base {
	...
	public function get_title() {
		return __( 'Therapist Loop Item', 'maputo' );
	}
	...
	protected function register_style_section_controls() {
		...
		$this->add_control(
			'title_background',[
				'label'     => esc_html__( 'Background Title', 'maputo' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'job_background',[
				'label'     => esc_html__( 'Background Job', 'maputo' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
