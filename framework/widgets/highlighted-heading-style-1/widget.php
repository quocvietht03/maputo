...
namespace MaputoElementorWidgets\Widgets\HighlightedHeadingStyle1;
...
class Widget_HighlightedHeadingStyle1 extends Widget_Base
{
	...
	{
		return __('Highlighted Heading Style 1', 'maputo');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$repeater->add_control(
			'text_title',
			[
				'label' => __('Text', 'maputo'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('Text Heading', 'maputo'),
			]
		);
		$repeater->add_control(
			'style_title',
			[
				'label' => __('Style', 'maputo'),
		...
		$this->add_control(
			'list',
			[
				'label' => __('List Style Heading', 'maputo'),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'text_title' => __('This is the heading', 'maputo'),
						'style_title' => '1'
					],
					[
						'text_title' => __('Highlighted', 'maputo'),
						'style_title' => '2'
					],
					[
						'text_title' => __('After heading', 'maputo'),
						'style_title' => '1'
					],
				],
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => __('Highlighted Text', 'maputo'),
